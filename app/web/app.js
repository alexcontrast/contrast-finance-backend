...
function injectManagerUxStyles() {
  ...
  style.textContent = `
    ...
    /* v0.40.64 — desktop table date column and numeric/header alignment polish. */
    @media (min-width: 721px) {
      ...
      .admin-requests-table td:nth-child(7) strong,
      .department-head-requests-table td:nth-child(7) strong,
...
/* v0.40.115 — mobile manager width containment after plan panel. */
@media (max-width: 920px) {
  body.manager-mode,
  body[data-cf-role="manager"] {
    overflow-x: hidden !important;
  }

  body.manager-mode #dashboardScreen,
  body.manager-mode #dashboardScreen > .card,
  body.manager-mode .manager-dashboard-v113,
  body.manager-mode .manager-plan-panel,
  body.manager-mode .manager-plan-panel-v113,
  ...
  body.manager-mode .manager-sidebar-card,
  body.manager-mode .manager-detail-card,
  body.manager-mode .manager-detail-card-v113,
  body.manager-mode .manager-event-card,
  body[data-cf-role="manager"] #dashboardScreen,
  body[data-cf-role="manager"] #dashboardScreen > .card,
  body[data-cf-role="manager"] .manager-dashboard-v113,
  body[data-cf-role="manager"] .manager-plan-panel,
  body[data-cf-role="manager"] .manager-plan-panel-v113,
  ...
  body.manager-mode .manager-plan-subline-v113 span,
  body.manager-mode .manager-plan-row strong,
  body[data-cf-role="manager"] .manager-plan-subline-v113 span,
  body[data-cf-role="manager"] .manager-plan-row strong {
    min-width: 0 !important;
    max-width: 100% !important;
    overflow: hidden !important;
  ...
  body.manager-mode .manager-plan-panel .progress-line,
  body[data-cf-role="manager"] .manager-plan-panel .progress-line {
    width: 100% !important;
    max-width: 100% !important;
  ...
  body.manager-mode .manager-mini-card .mini-badge-row .status-badge,
  body.manager-mode .manager-mini-card .mini-badge-row .coauthor-badge,
  body[data-cf-role="manager"] .manager-mini-card .mini-badge-row .status-badge,
  body[data-cf-role="manager"] .manager-mini-card .mini-badge-row .coauthor-badge {
    display: inline-flex !important;
    justify-content: center !important;
    align-items: center !important;
    width: 100% !important;
  ...
  body.manager-mode .manager-mini-card .mini-pill strong,
  body[data-cf-role="manager"] .manager-mini-card .mini-pill strong {
  ...
  body[data-cf-role="manager"] .manager-event-fields,
  body.manager-mode .estimate-tabs,
  body[data-cf-role="manager"] .estimate-tabs,
  body.manager-mode .manager-summary-grid,
  body[data-cf-role="manager"] .manager-summary-grid,
  body.manager-mode .external-estimate-totals,
  body[data-cf-role="manager"] .external-estimate-totals,
  body.manager-mode .manager-card-bottom-actions,
  body[data-cf-role="manager"] .manager-card-bottom-actions {
    width: 100% !important;
    max-width: 100% !important;
  ...
  body.manager-mode .event-badge-row,
  body[data-cf-role="manager"] .event-badge-row {
    max-width: 100% !important;
    min-width: 0 !important;
    gap: 5px !important;
    overflow: hidden !important;
  ...
  body.manager-mode .event-badge-row .status-badge,
  body.manager-mode .event-badge-row .coauthor-badge,
  body[data-cf-role="manager"] .event-badge-row .status,
  body[data-cf-role="manager"] .event-badge-row .status-badge,
  body[data-cf-role="manager"] .event-badge-row .coauthor-badge {
    max-width: 100% !important;
    padding: 5px 7px !important;
    font-size: 10.5px !important;
    line-height: 1 !important;
  ...
  body[data-cf-role="manager"] .manager-event-head .inline-actions button,
  body.manager-mode .estimate-tabs button,
  body[data-cf-role="manager"] .estimate-tabs button,
  body.manager-mode .manager-card-bottom-actions button,
  body[data-cf-role="manager"] .manager-card-bottom-actions button {
    width: 100% !important;
    max-width: 100% !important;
  ...
  body.manager-mode .manager-summary-grid .metric,
  body.manager-mode .external-estimate-totals .metric,
  body[data-cf-role="manager"] .manager-summary-grid .metric,
  body[data-cf-role="manager"] .external-estimate-totals .metric {
    min-width: 0 !important;
    max-width: 100% !important;
    padding: 8px !important;
    overflow: hidden !important;
  ...
  body.manager-mode .manager-summary-grid .metric .label,
  body.manager-mode .external-estimate-totals .metric .label,
  body[data-cf-role="manager"] .manager-summary-grid .metric .label,
  body[data-cf-role="manager"] .external-estimate-totals .metric .label {
    font-size: 9.5px !important;
    line-height: 1.1 !important;
    overflow: hidden !important;
    text-overflow: ellipsis !important;
  ...
  body.manager-mode .manager-summary-grid .metric .value,
  body.manager-mode .external-estimate-totals .metric .value,
  body[data-cf-role="manager"] .manager-summary-grid .metric .value,
  body[data-cf-role="manager"] .external-estimate-totals .metric .value {
    max-width: 100% !important;
    min-width: 0 !important;
    overflow: hidden !important;
    text-overflow: ellipsis !important;
  ...
  body.manager-mode #managerEstimatePanel,
  body[data-cf-role="manager"] #managerEstimatePanel,
  body.manager-mode #managerEstimatePanel .estimate-table-wrap,
  body[data-cf-role="manager"] #managerEstimatePanel .estimate-table-wrap {
    width: 100% !important;
    max-width: 100% !important;
    min-width: 0 !important;
    overflow-x: auto !important;
  ...
  body.manager-mode #managerEstimatePanel .estimate-table,
  body[data-cf-role="manager"] #managerEstimatePanel .estimate-table {
    width: max-content !important;
...
function updateHeaderUserInfo(user) {
  ...
  document.body.classList.toggle("accountant-mode", user.role === "accountant");
  ...
  $("pageSubtitle").textContent = user.role === "admin"
    ...
    : user.role === "accountant"
      ? "Чеки самозанятых и бухгалтерские документы"
      : "";
...
function resetRoleBodyClasses() {
  document.body.classList.remove("admin-mode", "department-head-mode", "manager-mode", "accountant-mode");
}
...
function accountingRequestStatusText(row) {
  const requestStatus = statusLabel(row?.request_status || "");
  const moneyStatus = statusLabel(row?.money_status || "");
  ...
  return `
    <div class="accounting-editor" data-accounting-editor="${handle}">
      ...
      <div class="accounting-form-grid">
        ...
        <label class="accounting-field">№ чека
          <input data-accounting-field="receipt_number" value="${escapeHtml(row.receipt_number || "")}" />
        </label>
        <label class="accounting-field">Дата и время чека
          <input data-accounting-field="receipt_datetime" type="datetime-local" value="${escapeHtml(accountingReceiptDateInputValue(row.receipt_datetime))}" />
        </label>
...
async function apiForm(path, formData, options = {}) {
  ...
  if (state.token) headers.Authorization = `Bearer ${state.token}`;
  const response = await fetch(path, { ...options, method: options.method || "POST", headers, body: formData });
  if (!response.ok) {
    let detail = `Ошибка ${response.status}`;
    try {
      const data = await response.json();
...
function loadAccountingScript(src, globalName) {
  ...
  return new Promise((resolve, reject) => {
    const existing = document.querySelector(`script[data-accounting-lib="${globalName}"]`);
    if (existing) {
      existing.addEventListener("load", () => resolve(), { once: true });
      existing.addEventListener("error", () => reject(new Error(`Не удалось загрузить ${globalName}`)), { once: true });
      return;
    }
    const script = document.createElement("script");
    script.src = src;
    script.async = true;
    script.dataset.accountingLib = globalName;
    script.onload = () => resolve();
    script.onerror = () => reject(new Error(`Не удалось загрузить модуль распознавания ${globalName}`));
...
function canvasFromImageFile(file) {
  return new Promise((resolve, reject) => {
    ...
    img.onerror = () => {
      URL.revokeObjectURL(url);
      reject(new Error("Не удалось открыть изображение чека"));
    };
    img.src = url;
  });
}
...
function accountingPreprocessCanvas(source) {
  const canvas = document.createElement("canvas");
  const upscale = source.width < 1300 ? Math.min(2, 1800 / Math.max(1, source.width)) : 1;
  canvas.width = Math.max(1, Math.round(source.width * upscale));
  canvas.height = Math.max(1, Math.round(source.height * upscale));
  const ctx = canvas.getContext("2d", { willReadFrequently: true });
  ctx.drawImage(source, 0, 0, canvas.width, canvas.height);
  const image = ctx.getImageData(0, 0, canvas.width, canvas.height);
  for (let i = 0; i < image.data.length; i += 4) {
    const gray = Math.round(image.data[i] * 0.299 + image.data[i + 1] * 0.587 + image.data[i + 2] * 0.114);
    const boosted = gray < 180 ? Math.max(0, gray - 20) : Math.min(255, gray + 18);
...
function accountingCleanMoney(text) {
  if (!text) return null;
  const normalized = String(text).replace(/[^0-9,.-]/g, "").replace(/,(\d{1,2})$/, ".$1");
...
function accountingParseESalyqText(rawText, requestAmount = null) {
  const text = accountingNormalizeOcrText(rawText);
...
function renderDepartmentHeadOverview(data) {
  ...
  return `
    <section class="department-head-plan-card-v107 ${departmentClass}">
      <div class="department-head-plan-desktop-v107">
        <div class="department-head-plan-label-v107">Общий план отдела</div>
        <div class="department-head-plan-name-v107">${escapeHtml(departmentName)}</div>
        <div class="department-head-plan-fact-v107">${formatMoney(data.fact_income_amount)} ₸</div>
        <div class="department-head-plan-subline-v107">
          <span>Цель: ${formatMoney(data.plan_amount)} ₸ · ${percent}%</span>
          ${eventsBadge}
        </div>
        <div class="department-head-plan-progress-v107">
          ${progressLine(percent)}
        </div>
        <div class="department-head-plan-muted-v107">${remainingLine}</div>
      </div>

      <div class="department-head-plan-mobile-v107">
        <h3 class="department-head-plan-mobile-name-v107">${escapeHtml(departmentName)}</h3>
        <div class="department-head-plan-mobile-label-v107">Общий план отдела</div>
        <div class="department-head-plan-mobile-fact-v107">${formatMoney(data.fact_income_amount)} ₸</div>
        <div class="department-head-plan-mobile-subline-v107">
          <span>Цель: ${formatMoney(data.plan_amount)} ₸ · ${percent}%</span>
          ${eventsBadge}
        </div>
        ${progressLine(percent)}
        <div class="muted department-head-plan-mobile-muted-v107">${remainingLine}</div>
      </div>
    </section>
...
function renderAdminEmptyDashboard(month, error = null) {
  ...
  } else if (state.activeAdminTab === "accounting") {
    $("dashboardContent").innerHTML = renderAccountingPanel();
  ...
  attachAccountingPanel();
  if (state.activeAdminTab === "accounting") {
    loadSelfEmployedAccounting(false).catch((loadError) => {
      const rowsEl = $("accountingRows");
      if (rowsEl) rowsEl.innerHTML = `<div class="error">${escapeHtml(loadError.message)}</div>`;
    });
  }
}
...
function renderAdminDashboard(data) {
  ...
  if (state.activeAdminTab === "overview") {
    ...
    if (state.accountingLoadedMonth !== selectedMonthValue()) state.accountingRows = [];
    $("dashboardContent").innerHTML = renderAccountingPanel();
  } else if (state.activeAdminTab === "plans") {
    $("dashboardContent").innerHTML = renderPlansSkeleton(data);
  } else if (state.activeAdminTab === "closing") {
  ...
  attachAccountingPanel();
  if (state.activeAdminTab === "accounting") {
    loadSelfEmployedAccounting(false).catch((error) => {
      console.error("Accounting load failed", error);
      const rowsEl = $("accountingRows");
      if (rowsEl) rowsEl.innerHTML = `<div class="error">${escapeHtml(error.message)}</div>`;
    });
  }
...
function clientEstimateFitText(ctx, text, x, y, maxWidth, options = {}) {
  const raw = String(text ?? "").replace(/\s+/g, " " ).trim();
  if (!raw) return;
  ...
  if (value !== raw) {
    while (value.length > 1 && ctx.measureText(`${value}${suffix}`).width > maxWidth) value = value.slice(0, -1);
    value = `${value}${suffix}`;
  }
  ctx.fillText(value, x, y);
}

function clientEstimatePdfEscape(value) {
  return String(value || "").replace(/\\/g, "\\\\").replace(/\(/g, "\\(").replace(/\)/g, "\\)");
}

function clientEstimateRectToPdf(rect, canvasW, canvasH, pageWidthPt, pageHeightPt) {
  const x1 = rect.x / canvasW * pageWidthPt;
  const x2 = (rect.x + rect.w) / canvasW * pageWidthPt;
  const y1 = pageHeightPt - ((rect.y + rect.h) / canvasH * pageHeightPt);
  const y2 = pageHeightPt - (rect.y / canvasH * pageHeightPt);
  return [x1, y1, x2, y2].map((n) => Number(n.toFixed(2)));
}

function clientEstimateDrawInstagramIcon(ctx, x, y, size) {
  const radius = Math.max(5, size * 0.23);
  ...
  ctx.stroke();
  ctx.beginPath();
  ctx.arc(x + size * 0.73, y + size * 0.28, size * 0.055, 0, Math.PI * 2);
...
function clientEstimateDrawFooter(ctx, w, h) {
  ...
  ctx.textAlign = "right";
  ctx.fillText("Организация мероприятий любого формата и сложности", w - 42, h - 34);
  ctx.restore();
}

function clientEstimateDrawPageBase(ctx, canvas, logo, event, links) {
  ...
  if (logo) {
    const logoH = 76;
    const logoW = Math.min(310, logo.width * (logoH / logo.height));
    ctx.drawImage(logo, 40, 34, logoW, logoH);
  } else {
    ctx.font = "bold 38px Arial, sans-serif";
    ctx.fillStyle = "#1f7a3d";
    ctx.fillText("CONTRAST", 40, 80);
  }
  ...
  const top = 188;
  const colW = (w - 80) / 2;
  const managerName = state.bootstrap?.user?.name || event?.manager_name || "Contrast";
  const managerPhone = formatPhoneKzPretty(state.bootstrap?.user?.phone || event?.manager_phone || event?.managerPhone || "");
  ...
  line("Мероприятие", event?.title || "—", left, top + 78);
  line("Исполнитель", managerValue, left + colW, top + 78);

  clientEstimateDrawFooter(ctx, w, h);
}

function clientEstimateDrawTableHeader(ctx, y, columns) {
  ctx.fillStyle = "#dff0e5";
  ctx.fillRect(40, y, 1110, 40);
...
function clientEstimateDrawTotals(ctx, y, columns, totals, event) {
  ...
  const drawTotal = (label, value, tone = "normal") => {
    ...
    ctx.font = tone === "final" ? "bold 20px Arial, sans-serif" : "bold 16px Arial, sans-serif";
  ...
  drawTotal(`КОМИССИЯ АГЕНТСТВА ${formatPlainNumber(event?.agency_commission_amount)}%`, totals.agency);
  ...
  drawTotal("ИТОГО К ОПЛАТЕ:", totals.total, "final");
  return y;
}

function clientEstimateMakePdfFromJpegs(jpegs, options = {}) {
  const pageWidthPt = options.pageWidthPt || 595;
  const pageHeightPt = options.pageHeightPt || 842;
  const imageWidth = options.imageWidth || 1190;
  const imageHeight = options.imageHeight || 1684;
  const linksByPage = options.linksByPage || [];
  ...
  jpegs.forEach((dataUrl, index) => {
    ...
    const imgId = addObject({
      head: `<< /Type /XObject /Subtype /Image /Width ${imageWidth} /Height ${imageHeight} /ColorSpace /DeviceRGB /BitsPerComponent 8 /Filter /DCTDecode /Length ${imgBytes.length} >>\nstream\n`,
      stream: imgBytes,
      tail: `\nendstream\n`,
    });
    const content = `q\n${pageWidthPt} 0 0 ${pageHeightPt} 0 0 cm\n/Im${index} Do\nQ\n`;
    const contentId = addObject({ body: `<< /Length ${content.length} >>\nstream\n${content}endstream\n` });
    const annotIds = (linksByPage[index] || []).map((link) => {
      const [x1, y1, x2, y2] = clientEstimateRectToPdf(link.rect, imageWidth, imageHeight, pageWidthPt, pageHeightPt);
      return addObject({ body: `<< /Type /Annot /Subtype /Link /Rect [${x1} ${y1} ${x2} ${y2}] /Border [0 0 0] /A << /S /URI /URI (${clientEstimatePdfEscape(link.url)}) >> >>\n` });
    });
    const annots = annotIds.length ? ` /Annots [${annotIds.map((id) => `${id} 0 R`).join(" " )}]` : "";
    const pageId = addObject({ body: `<< /Type /Page /Parent 2 0 R /MediaBox [0 0 ${pageWidthPt} ${pageHeightPt}] /Resources << /XObject << /Im${index} ${imgId} 0 R >> >> /Contents ${contentId} 0 R${annots} >>\n` });
    pageIds.push(pageId);
  });

  objects[0] = { body: `<< /Type /Catalog /Pages 2 0 R >>\n` };
  objects[1] = { body: `<< /Type /Pages /Kids [${pageIds.map((id) => `${id} 0 R`).join(" " )}] /Count ${pageIds.length} >>\n` };
...
async function generateClientEstimatePdf(eventId) {
  ...
  try {
    ...
    const links = [];
    clientEstimateDrawPageBase(ctx, canvas, logo, event, links);

    const totalsRows = 2 + (totals.simplifiedMarkup > 0 ? 1 : 0) + (totals.vat > 0 ? 1 : 0);
    const totalsHeight = totalsRows * 40 + 52;
    const tableTop = 352;
    const tableHeaderH = 40;
    const tableBottom = 1684 - 80 - totalsHeight;
    const availableRowsHeight = Math.max(260, tableBottom - tableTop - tableHeaderH - 14);
    const rowH = Math.max(24, Math.min(44, Math.floor(availableRowsHeight / Math.max(1, items.length))));
    const mainFont = rowH <= 26 ? 12 : rowH <= 32 ? 13 : 14;
    const noteFont = Math.max(11, mainFont - 1);
    ...
    clientEstimateDrawTotals(ctx, y + 14, columns, totals, event);

    const jpeg = canvas.toDataURL("image/jpeg", 0.94);
    const blob = clientEstimateMakePdfFromJpegs([jpeg], {
      pageWidthPt: 595,
      pageHeightPt: 842,
  ...
  return `
    <section class="manager-event-card ${isReadonlyReview ? "is-readonly" : ""}" style="${isReadonlyReview ? "background: rgba(115,120,130,.045);" : ""}">
      <div class="manager-event-head">
        ...
        <div class="manager-event-actions manager-event-actions-v118">
          ${isAdminEditMode ? `
...
async function loadClosingPanelData(options = {}) {
  ...
  if (!includeCalculation) {
    const expenses = await api(`/monthly-expenses?month=${month}&_=${Date.now()}`);
    const result = {
      month,
...
function scheduleClosingCalculationRefresh(delayMs = 900) {
  ...
  state.closingCalcRefreshTimer = setTimeout(async () => {
    ...
    try {
      const calcResult = await api(`/monthly-closings/calculate?month=${month}&_=${Date.now()}`)
...
function renderDashboardLoading(role) {
  const title = role === "admin" ? "Админка" : role === "department_head" ? "Кабинет отдела" : role === "accountant" ? "Бухгалтерия" : "Мои мероприятия";
...
async function boot() {
  console.info("Contrast Finance web app v0.5.120 loaded");
  if (!state.token) {
    stopLiveEventSync();
