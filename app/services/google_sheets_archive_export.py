...
def build_month_export_sections(db: Session, month_date: date) -> dict:
    ...
    # A paid monthly bonus is both a department expense and part of the
    # manager's salary statistics. The expense total above already includes it;
    # here we add it only to the manager salary breakdown.
    for expense in expenses:
